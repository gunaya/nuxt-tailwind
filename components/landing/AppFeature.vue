        ...
        <div class="max-w-screen-xl p-4 mx-auto px-4 sm:px-6 lg:px-8 relative py-26 lg:mt-20">
            <div class="relative">
                <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                    <div class="lg:col-start-2 lg:max-w-2xl ml-auto" data-aos="fade-up" data-aos-delay="300">
                        <p class="text-base leading-6 text-teal-600 dark:text-indigo-500 font-semibold uppercase">
                            Interactive
                        </p>
                        ...
                        <ul class="mt-8 md:grid md:grid-cols-2 gap-6">
                            <li class="mt-6 lg:mt-0">
                                <div class="flex">
                                    <span class="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full text-teal-500 dark:text-indigo-500 border-teal-500  dark:border-indigo-500 border-2">
                    ...
                    <div class="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
                        <div class="relative space-y-4">
                            <div class="flex items-end justify-center lg:justify-start space-x-4">
                                <img class="rounded-lg shadow-lg w-32 md:w-56 bg-gray-400" width="200" src="/images/landscape/4.jpg" alt="1" data-aos="zoom-in-up" data-aos-delay="100"/>
                                <img class="rounded-lg shadow-lg w-40 md:w-64 bg-gray-400" width="260" src="/images/landscape/4.jpg" alt="2" data-aos="zoom-in-up" data-aos-delay="200"/>
                            </div>
                            <div class="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                                <img class="rounded-lg shadow-lg w-24 md:w-40 bg-gray-400" width="170" src="/images/landscape/4.jpg" alt="3" data-aos="zoom-in-left"  data-aos-delay="150"/>
                                <img class="rounded-lg shadow-lg w-32 md:w-56 bg-gray-400" width="200" src="/images/landscape/4.jpg" alt="4" data-aos="zoom-in-right" data-aos-delay="250"/>
                            </div>
                        </div>
                    </div>
                </div>
