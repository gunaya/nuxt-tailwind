            ...
            <div class="flex justify-center mt-6">
                <div class="bg-white border rounded-md focus-within:ring dark-focus-within:border-indigo-500 focus-within:border-teal-600">
                    <div class="flex flex-wrap justify-between md:flex-row">
                        ...
                        <button class="w-full p-2 m-1 text-sm font-semibold text-white uppercase transition-colors duration-200 transform bg-teal-600 dark:bg-indigo-600 rounded-md lg:w-auto hover:bg-gray-700">subscribe</button>
                    </div>
                </div>
            </div>
        </div>
