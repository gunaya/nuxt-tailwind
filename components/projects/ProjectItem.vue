<template>
    <div class="flex flex-col items-center justify-center max-w-sm mx-auto mb-8" data-aos="fade-up">
        <div class=" w-full md:w-72 xl:w-96 h-64 bg-gray-400 bg-center bg-cover rounded-lg shadow-md" style="background-image: url(https://images.unsplash.com/photo-1521903062400-b802f2cb8cb9d?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1050&q=80)"></div>
